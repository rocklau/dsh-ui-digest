/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-client-ui-digest`.
 * @module @deepseek-ai/dsh-client-ui-digest/invariant
 */
const PACKAGE_NAME = '@deepseek-ai/dsh-client-ui-digest';
/** Cordis companion plugin name. */
export const name = 'client-ui-digest-invariant';
